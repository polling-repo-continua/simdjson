...
private:
  ...
  really_inline void next(const simd::simd8x64<uint8_t>& in, const json_block& block, size_t idx);
...
really_inline void json_structural_indexer::next(const simd::simd8x64<uint8_t>& in, const json_block& block, size_t idx) {
